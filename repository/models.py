...
class UserProfile(models.Model):
    ...
    用户信息
    """
    nickname = models.CharField(u'姓名', max_length=32)
    email = models.EmailField(u'邮箱')
    phone = models.CharField(u'座机', max_length=32,null=True,blank=True)
    mobile = models.CharField(u'手机', max_length=32)
    user = models.OneToOneField(User,on_delete=models.CASCADE)
    login_state = models.CharField(verbose_name='登录是否锁定', max_length=2, default=0)
    login_lock_date = models.DateTimeField('登录锁定时间',null=True,max_length=32,blank=True,default="1970-01-01 00:00:00")
    pass_err_count = models.IntegerField(verbose_name='用户密码输入次数', default=0)
    isNot_login = models.BooleanField(default=False)
    last_login_date = models.DateTimeField('上一次登录时间',null=True,max_length=32,blank=True)
    session = models.CharField(max_length=32,null=True,default="None",blank=True)
    class Meta:
