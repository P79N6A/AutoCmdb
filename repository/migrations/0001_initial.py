    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_state', models.CharField(default=0, max_length=2, verbose_name='登录是否锁定')),
                ('login_lock_date', models.DateTimeField(max_length=32, null=True, verbose_name='登录锁定时间')),
                ('pass_err_count', models.IntegerField(default=0, verbose_name='用户密码输入次数')),
                ('isNot_login', models.BooleanField(default=False)),
                ('last_login_date', models.DateTimeField(max_length=32, null=True, verbose_name='上一次登录时间')),
