...
# The contents of the "HEX" grammar role for HTTP, upper and lowercase A-F plus digits,
...
class WSGIHandler(object):
    ...
    def get_environ(self):
        ...
        This should begin with asking the server for the basic environment
...
class Environ(dict):
    """
    A basic class that can be used for WSGI environment objects.
