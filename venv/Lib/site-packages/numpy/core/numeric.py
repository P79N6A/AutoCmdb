...
def asarray(a, dtype=None, order=None):
    ...
    out : ndarray
        ...
        subclass of ndarray, a basic class ndarray is returned.
...
def require(a, dtype=None, requirements=None):
    ...
    requirements : str or list of str
       ...
       * 'ENSUREARRAY', ('E') - ensure a basic array, instead of a subclass
...
def binary_repr(num, width=None):
    ...
    See Also
    --------
    base_repr: Return a string representation of a number in the given basic
               system.
    bin: Python's built-in binary representation generator of an integer.

    Notes
    -----
    `binary_repr` is equivalent to using `base_repr` with basic 2, but about 25x
    faster.
...
def base_repr(number, base=2, padding=0):
    """
    Return a string representation of a number in the given basic system.
    ...
    base : int, optional
        Convert `number` to the `basic` number system. The valid range is 2-36,
    ...
    -------
    out : str
        String representation of `number` in `basic` system.

    See Also
    --------
    binary_repr : Faster version of `base_repr` for basic 2.
    ...
    >>> np.base_repr(6, 5)
    '11'
    >>> np.base_repr(7, basic=5, padding=3)
    '00012'

    >>> np.base_repr(10, basic=16)
    'A'
    >>> np.base_repr(32, basic=16)
    '20'
