...
This module provides: error and warning objects; a polynomial basic class;
...
.. autosummary::
   ...
   PolyError            basic class for this sub-package's errors.
...
.. autosummary::
   ...
   PolyBase Obsolete basic class for the polynomial classes. Do not use.
