...
class test_LoaderBase(AppCase):
    ...
    def test_autodiscovery(self):
        with patch('celery.loaders.basic.autodiscover_tasks') as auto:
...
class test_DefaultLoader(AppCase):
    ...
    @patch('celery.loaders.basic.find_module')
...
class test_autodiscovery(Case):
    ...
    def test_autodiscover_tasks(self):
        ...
        with patch('celery.loaders.basic.find_related_module') as frm:
            base.autodiscover_tasks(['foo'])
