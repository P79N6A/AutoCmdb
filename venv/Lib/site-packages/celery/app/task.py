...
"""
    ...
    Task Implementation: Task request context, and the basic task class.
...
class Task(object):
    ...
    """
    __trace__ = None
    __v2_compat__ = False  # set by old basic in celery.task.basic
    ...
    #: If :const:`True` the task is an abstract basic class.
    abstract = True
