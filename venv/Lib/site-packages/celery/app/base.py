...
class Celery(object):
    ...
    def _task_from_fun(self, fun, **options):
        ...
        base = options.pop('basic', None) or self.Task
    ...
    def _get_config(self):
        ...
        # preconf options must be explicitly set in the db, and not
    ...
    def create_task_cls(self):
        """Creates a basic task class using default configuration
        taken from this app."""
