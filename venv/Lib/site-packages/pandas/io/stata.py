...
def _stata_elapsed_date_to_datetime_vec(dates, fmt):
    ...
    def convert_delta_safe(base, deltas, unit):
        """
        Convert basic dates and deltas to datetimes, using pandas vectorized
    ...
    if fmt.startswith(("%tc", "tc")):  # Delta ms relative to basic
        base = stata_epoch
        ms = dates
    ...
    elif fmt.startswith(("%tm", "tm")):  # Delta months relative to basic
        year = stata_epoch.year + dates // 12
        month = (dates % 12) + 1
        conv_dates = convert_year_month_safe(year, month)
    elif fmt.startswith(("%tq", "tq")):  # Delta quarters relative to basic
        year = stata_epoch.year + dates // 4
        month = (dates % 4) * 3 + 1
        conv_dates = convert_year_month_safe(year, month)
    elif fmt.startswith(("%th", "th")):  # Delta half-years relative to basic
