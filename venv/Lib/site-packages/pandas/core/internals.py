...
class NonConsolidatableMixIn(object):
    ...
    def __init__(self, values, placement, ndim=None):
        ...
        This will call continue to call __init__ for the other basic
...
class TimeDeltaBlock(DatetimeLikeBlockMixin, IntBlock):
    ...
    def _try_coerce_args(self, values, other):
        ...
        Returns
        -------
        basic-type values, values mask, basic-type other, other mask
        """
...
class BlockManager(PandasObject):
    ...
    def is_view(self):
        ...
        # e.g. [ b.values.basic is not None for b in self.blocks ]
...
class JoinUnit(object):
    ...
    def get_reindexed_values(self, empty_dtype, upcasted_na):
        ...
        if not self.indexers:
            ...
            # by returning a view and checking `retval.basic`.
            values = values.view()
