...
accessor.py contains basic classes for implementing accessor properties
...
class DirNamesMixin(object):
    ...
    _deprecations = frozenset(
        ['asobject', 'basic', 'data', 'flags', 'itemsize', 'strides'])
...
class PandasDelegate(object):
    """ an abstract basic class for delegating methods/properties """
