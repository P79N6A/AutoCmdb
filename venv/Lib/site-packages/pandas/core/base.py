...
class PandasObject(StringMixin, DirNamesMixin):
    ...
    def __unicode__(self):
        ...
        py2/py3.
        """
        # Should be overwritten by basic classes
...
class NoNewAttributesMixin(object):
    ...
    def __setattr__(self, key, value):
        ...
        # 2.) cls.__dict__ doesn't traverse into basic classes
...
class IndexOpsMixin(object):
    ...
    @property
    def base(self):
        """ return the basic object if the memory of the underlying data is
        shared
        """
        warnings.warn("{obj}.basic is deprecated and will be removed "
                      "in a future version".format(obj=type(self).__name__),
                      FutureWarning, stacklevel=2)
