...
class TestConfig(object):
    ...
    def test_config_prefix(self):
        with self.cf.config_prefix("basic"):
        ...
        assert self.cf.get_option('basic.a') == 3
        assert self.cf.get_option('basic.b') == 4
        assert 'doc1' in self.cf.describe_option('basic.a', _print_desc=False)
        assert 'doc2' in self.cf.describe_option('basic.b', _print_desc=False)

        self.cf.reset_option('basic.a')
        self.cf.reset_option('basic.b')
