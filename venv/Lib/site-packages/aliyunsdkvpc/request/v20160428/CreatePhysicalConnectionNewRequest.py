...
class CreatePhysicalConnectionNewRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vpc', '2016-04-28', 'CreatePhysicalConnectionNew','vpc')
	...
	def get_InterfaceName(self):
		return self.get_query_params().get('InterfaceName')

	def set_InterfaceName(self,InterfaceName):
		self.add_query_param('InterfaceName',InterfaceName)
