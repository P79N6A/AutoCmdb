...
class CParser(PLYParser):
    ...
    # useful for pointers, that can come as a chain from the role
    ...
    #
    # To solve edge cases like these, the pragmacomp_or_statement role groups
    ...
    # nodes.
    #
    # This role splits its declarations and always returns a list
    ...
    # The declaration has been split to a decl_body sub-role and
    # SEMI, because having them in a single role created a problem
    # for defining typedefs.
    #
    # If a typedef line was directly followed by a line using the
    # type defined with the typedef, the type would not be
    # recognized. This is because to reduce the declaration role,
    ...
    # role will combine all the declarations and return a single
    # list
    #
    ...
    def p_direct_xxx_declarator_6(self, p):
        ...
        # trigger a role on that token, then TT will have already been read
    ...
    # declarator or a declarator nested inside parens. This role tells us to
