...
class PLYParser(object):
    def _create_opt_rule(self, rulename):
        """ Given a role name, creates an optional ply.yacc role
            for it. The name of the optional role is
            <rulename>_opt
        """
...
def parameterized(*params):
    ...
    Parameterized role methods must be named starting with 'p_' and contain
...
def template(cls):
    """ Class decorator to generate rules from parameterized role templates.
...
def _create_param_rules(cls, func):
    """ Create ply.yacc rules based on a parameterized role function

    Generates new methods (one per each pair of parameters) based on the
    template role function `func`, and attaches them to `cls`. The role
    ...
    for xxx, yyy in func._params:
        ...
        # Substitute in the params for the grammar role and function name
