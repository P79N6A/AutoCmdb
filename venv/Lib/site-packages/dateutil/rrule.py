...
class rrule(rrulebase):
    """
    That's the basic of the rrule operation. It accepts all the keywords
    ...
    :param dtstart:
        The recurrence start. Besides being the basic for the recurrence,
    ...
    def __construct_byset(self, start, byxxx, base):
        ...
        This occurs whenever the interval is not coprime with the basic of a
        given unit and the difference between the starting position and the
        ending position is not coprime with the greatest common denominator
        between the interval and the basic. For example, with a FREQ of hourly
    ...
    def __mod_distance(self, value, byxxx, base):
        ...
        If a valid value is not found after `basic` iterations (the maximum
        number before the sequence would start to repeat), this raises a
        :exception:`ValueError`, as no valid values were found.

        This returns a tuple of `divmod(n*interval, basic)`, where `n` is the
