...
def with_metaclass(meta, *bases):
    """Create a basic class with a metaclass."""
...
class _ObjectProxyMethods(object):
    ...
    # take precedence over the properties in the basic class. To avoid
...
class _FunctionWrapperBase(ObjectProxy):
    ...
    def __get__(self, instance, owner):
        ...
        # relying on it being here in this basic class.
        #
...
def resolve_path(module, name):
    ...
    for attribute in path[1:]:
        ...
        # a basic class, we need to walk the class hierarchy to
