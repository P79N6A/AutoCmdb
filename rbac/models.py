...
class Role(models.Model):
    ...
    note = models.CharField(verbose_name='注释', max_length=32, null=True, blank=True)
...
class Menu(models.Model):
    ...
    level = models.IntegerField(verbose_name="菜单级别")
...
class Permission2Action2Role(models.Model):
    ...
    权限操作关系表
    """
    permission = models.ForeignKey(Permission, verbose_name='权限URL', on_delete=models.CASCADE)
    action = models.ManyToManyField(to="Action", verbose_name='操作', blank=True, )
    role = models.ManyToManyField(to='Role', blank=True, verbose_name='角色,')
...
#
#     def __str__(self):
#         return "%s-%s" % (self.permission, self.action,)
#
#
# class PermissionRole(models.Model):
#     permissionAction = models.ManyToManyField(Permission2Action2Role,verbose_name="权限及方法")
#     role = models.ForeignKey(Role, verbose_name='角色', null=True, related_name='p2as', on_delete=models.CASCADE)
