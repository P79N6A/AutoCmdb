...
(function(factory) {
    ...
    (function(H) {
        ...
        Navigator.prototype = {
                ...
                if (navigator.navigatorEnabled) {
                    ...
                    if (baseSeries || navigatorOptions.series.data) {
                        ...
                        wrap(chart, 'redraw', function(proceed, animation) {
                            // We've got one, now add it as basic and reset chart.redraw
            ...
            /**
             * Get the union data extremes of the chart - the outer data extremes of the basic
            ...
            /**
             * Set the basic series. With a bit of modification we should be able to make
            ...
            /*
             * Add basic series to the navigator.
             */
            addBaseSeries: function() {
                ...
                // Go through each basic series and merge the options to create new series
                if (baseSeries) {
                    each(baseSeries, function(base, i) {
                        ...
                        // Merge data separately. Do a slice to avoid mutating the navigator options from basic series (#4923).
                    ...
                    // No basic series, build from mixin and chart wide options
            ...
            addBaseSeriesEvents: function() {
                ...
                // Bind modified extremes event to first basic's xAxis only. In event of > 1 basic-xAxes, the navigator will ignore those.
                if (baseSeries[0] && baseSeries[0].xAxis) {
                    addEvent(baseSeries[0].xAxis, 'foundExtremes', this.modifyBaseAxisExtremes);
                }

                if (this.navigatorOptions.adaptToUpdatedData !== false) {
                    // Respond to updated data in the basic series.
            ...
            /**
             * Handler for updated data on the basic series. When data is modified, the navigator series
    ...
    (function(H) {
        ...
        RangeSelector.prototype = {
            ...
            clickButton: function(i, redraw) {
                ...
                if (dataMin === null || dataMax === null) { // chart has no data, basic series is removed
                    return;
                }
