...
(function(root, factory) {
    ...
    (function(H) {
         ...
         *    the setting defines a length relative to a basic size, for example the size
         *    of a container.
         */
        /**
    ...
    (function(H) {
        ...
        /**
         * The basic function which all other series types inherit from. The data in the series is stored
         * in various arrays.
         *
         ...
         */
        H.Series = H.seriesType('line', null, { // basic series options
    ...
    (function(H) {
        ...
        seriesType('area', 'line', {
            ...
            /**
             * Draw the graph and the underlying area. This method calls the Series basic
    ...
    (function(H) {
        ...
        /**
         * Handle a single responsiveness role
         */
        Chart.prototype.matchResponsiveRule = function(rule, redraw) {
            ...
            if (!respRules[rule._id] && matches) {
                ...
                // Unapply a role based on the previous options before the role
                // was applied
         ...
         * the chart with a new responsiveness role.
