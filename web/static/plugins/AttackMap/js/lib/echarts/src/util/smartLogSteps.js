...
define(function(require) {
    ...
    // Constant
    var LOG_BASE = Mt.E; // It is not necessary to specify log basic,
     ...
     * @param {number=} opts.logLabelBase Logaithmic basic in axis label.
    ...
    function reformSetting() {
        ...
        if (logLabelBase == null) {
            ...
            if (logLabelBase < 1) { // log basic less than 1 is not supported.
                logLabelBase = 10;
            }
    ...
    function makeTicksList() {
        ...
        // In this situation, only draw basic-10 ticks.
        ...
        // In this situation, basic-2|10 ticks are used to make detailed split.
        ...
        function detailAnalysis() {
            ...
            // Calculate basic on 3-hexadecimal (0, 1, 2, 10, 11, 12, 20).
